...
class SuperAdminIncidentListTab extends StatefulWidget {
  final String initialStatusFilter;
  final String initialPriorityFilter;

  const SuperAdminIncidentListTab({
    super.key,
  ...
  @override
  State<SuperAdminIncidentListTab> createState() => _SuperAdminIncidentListTabState();
}

class _SuperAdminIncidentListTabState extends State<SuperAdminIncidentListTab> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      debugPrint('SuperAdminIncidentListTab._load error: $e');
      if (!mounted) return;
                            ...
                            delegate: SliverChildBuilderDelegate((context, index) {
                              ...
                              return Padding(
                                ...
                                child: AdminIncidentCard(
                                  ...
                                  onAssign: item.status == statusOpen ? () => _quickAssign(item) : null,
                                ),
                              );
